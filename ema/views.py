...
# region Constants
EMA_HOURS = [8, 11, 14, 17, 20, 23]  # expected hours for ema responses
...
def submit_api(request):
    ...
    if 'username' in json_body and \
        ...
        ans1, ans2, ans3, ans4 = json_body['answers'].split(" ")
        ...
        current_ema_row.answer1 = ans1
        current_ema_row.answer2 = ans2
        current_ema_row.answer3 = ans3
        current_ema_row.answer4 = ans4
